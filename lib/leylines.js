...
exports.createSite = function(req, res, connectionString, callback) {
	...
	var select = "SELECT " + maintable + ".site," + maintable + ".description," + maintable + ".data_owner," + maintable + ".x_coord," + maintable + ".y_coord," + maintable + ".z_coord," + maintable + ".country" + " FROM "  + maintable;
