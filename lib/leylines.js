...
exports.createRamar = async function(req, res, pool) {
   ...
   var select = "SELECT id, site, place, location, description, object_type, image, x_coord, y_coord, country FROM ramar.poi";
   ...
   try {
      ...
      for (var i=0, tot=rows.length; i<tot; i++) {
         var description = "<!--HTML-->\r\n";
         description += "<table>";
         description += "<tr><td colspan=\"3\"><img src=\"" + rows[i].image + "\" alt=\"" + site + "\" style=\"width:360px\"></td></tr>";
         description += "<tr><td>Name</td><td width=\"50px\"></td><td>" + rows[i].site + "</td></tr>";
         description += "<tr><td>Description</td><td width=\"50px\"></td><td>" + rows[i].description + "</td></tr>";
         description += "<tr><td>Place</td><td></td><td>" + rows[i].place + "</td></tr>";
         description += "<tr><td>Location</td><td></td><td>" + rows[i].location + "</td></tr>";
