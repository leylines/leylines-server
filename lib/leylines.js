...
exports.createGrid = function(req, res, connectionString) {
	...
	rowdetails = grid.calculateGridPoints(req.params.lat1, req.params.lon1, azi, req.params.shape, req.params.type);

    grid.createGrid(connectionString, rowdetails, req.params.shape, req.params.type, czmlfile, function(results) {
          return res.json(results);
          //jsonfile = results;
          //console.log("results2: " + jsonfile);
    });

	//czmlfile = grid.createGrid(connectionString, rowdetails, req.params.shape, req.params.type, czmlfile); 

    //console.log("Final File: " + jsonfile);
