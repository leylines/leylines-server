...
exports.createGrid = async function(req, res, pool) {
    ...
    switch (type) {
       ...
       case "2":
          try {
             czmlfile = geometry.createCorridor(res, points, eval('grids.minor' + shape), distanceMain, colorMain, czmlfile);
          } catch (error) {
             console.log('caught', error.message);
          }
          try {
             postgis.pgFindPOI(res, pool, points, eval('grids.minor' + shape), distanceMain, colorMain, czmlfile, getResult);
          } catch (error) {
             console.log('caught', error.message);
          }
          return;
...
exports.createPOI = function(req, res, pool) {
	...
	postgis.pgCreatePoint(res, pool, select, req.params.type, scale, czmlfile, getResult);
...
exports.createSite = function(req, res, pool) {
	...
	postgis.pgCreatePoint(res, pool, select, req.params.table, scale, czmlfile, getResult);
...
exports.createLine = function(req, res, pool) {
    ...
    postgis.pgCreateLine(res, pool, maintable, linewidth, color, czmlfile, getResult);
};
...
exports.createMegalithic = function(req, res, pool) {
