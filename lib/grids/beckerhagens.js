...
exports.level2 = function(data, results) {
    ...
    line = [58, 37, 57, 49, 53, 61, 36, 59, 51, 50, 58];
    description  = line;
    geometry.createCorridor(data, line, description, linewidth, colorvalue, results);

    line = [42, 58, 55, 39, 33, 45, 61, 54, 38, 32, 42];
    description  = line;
    geometry.createCorridor(data, line, description, linewidth, colorvalue, results);

    line = [42, 50, 35, 48, 40, 45, 53, 34, 52, 44, 42];
    description  = line;
    geometry.createCorridor(data, line, description, linewidth, colorvalue, results);

    line = [43, 51, 35, 47, 39, 41, 49, 34, 46, 38, 43];
    description  = line;
    geometry.createCorridor(data, line, description, linewidth, colorvalue, results);

    line = [32, 43, 59, 56, 40, 33, 41, 57, 60, 44, 32];
    description  = line;
    geometry.createCorridor(data, line, description, linewidth, colorvalue, results);

    line = [56, 48, 47, 55, 37, 60, 52, 46, 54, 36, 56];
    description  = line;
    geometry.createCorridor(data, line, description, linewidth, colorvalue, results);
