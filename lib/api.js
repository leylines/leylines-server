...
module.exports = function(options) {
  ...
  router.get('/points/:schema/:table/:type', function(req, res) {
      leylines.createPOI(req, res, pgConnectionString, getResult);
  });

  router.get('/sites/:schema/:table/:type', function(req, res) {
      leylines.createSite(req, res, pgConnectionString, getResult);
  });
  ...
  router.get('/createGrid/:lat1/:lon1/:azi/:shape/:type', function(req, res) {
      leylines.createGrid(req, res, pgConnectionString, getResult);
  });
  ...
  router.get('/line/:schema/:table/:width/:color', function(req, res) {
      leylines.createLine(req, res, pgConnectionString, getResult);
  });
