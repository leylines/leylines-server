    ...
    switch (shape) {
        ...
        case "beckerhagens":
            ...
            switch (level) {
                ...
                case "1":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.beckerhagensMain, distanceMain, colorMain, czmlfile),
                       postgis.pgFindPOI,
                ...
                case "2":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.beckerhagensMinor, distanceMinor, colorMinor, czmlfile),
                       postgis.pgFindPOI,
                       ], function(err, czmlfile){
                          callback(czmlfile);
                    });
        ...
        case "cube":
            switch (level) {
                ...
                case "1":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.cubeMain, distanceMain, colorMain, czmlfile),
                       postgis.pgFindPOI,
                       ], function(err, czmlfile){
                          callback(czmlfile);
                    });
                ...
                case "2":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.cubeMinor, distanceMinor, colorMinor, czmlfile),
                       postgis.pgFindPOI,
                       ], function(err, czmlfile){
                          callback(czmlfile);
                    });
        ...
        case "dodecahedron":
            switch (level) {
                ...
                case "1":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.dodecahedronMain, distanceMain, colorMain, czmlfile),
                       postgis.pgFindPOI,
                       ], function(err, czmlfile){
                          callback(czmlfile);
                    });
                ...
                case "2":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.dodecahedronMinor, distanceMinor, colorMinor, czmlfile),
                       postgis.pgFindPOI,
                       ], function(err, czmlfile){
                          callback(czmlfile);
                    });
        ...
        case "icosahedron":
            switch (level) {
                ...
                case "1":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.icosahedronMain, distanceMain, colorMain, czmlfile),
                       postgis.pgFindPOI,
                       ], function(err, czmlfile){
                          callback(czmlfile);
                    });
                ...
                case "2":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.icosahedronMinor, distanceMinor, colorMinor, czmlfile),
                       postgis.pgFindPOI,
                       ], function(err, czmlfile){
                          callback(czmlfile);
                    });
        ...
        case "tetrahedron":
            switch (level) {
                ...
                case "1":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.tetrahedronMain, distanceMain, colorMain, czmlfile),
                       postgis.pgFindPOI,
                       ], function(err, czmlfile){
                          callback(czmlfile);
                    });
                ...
                case "2":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.tetrahedronMain, distanceMinor, colorMinor, czmlfile),
                       postgis.pgFindPOI,
                       ], function(err, czmlfile){
                          callback(czmlfile);
                    });
        ...
        case "octahedron":
            switch (level) {
                ...
                case "1":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.octahedronMain, distanceMain, colorMain, czmlfile),
                       postgis.pgFindPOI,
                       ], function(err, czmlfile){
                          callback(czmlfile);
                    });
                ...
                case "2":
                    async.waterfall([
                       geometry.createCorridor(connectionString, data, grids.octahedronMain, distanceMinor, colorMinor, czmlfile),
                       postgis.pgFindPOI,
                       ], function(err, czmlfile){
                          callback(czmlfile);
                    });
