...
exports.pgCreatePoint = async function(res, pool, select, type, scale, czmlfile, callback) {
...
exports.pgCreateLine = async function(res, pool, maintable, linewidth, color, czmlfile, callback) {
