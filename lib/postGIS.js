...
exports.pgFindPOI = function(connectionString, data, lines, distance, color, czmlfile, callback) {
...
exports.pgCreatePoint = function(connectionString, select, type, scale, czmlfile, callback) {
...
exports.pgCreateLine = function(connectionString, maintable, linewidth, color, czmlfile, callback) {
...
exports.pgCreateArea = function(connectionString, maintable, name, color, extrudeheight, czmlfile, callback) {
