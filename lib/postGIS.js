...
exports.pgFindPOI = function(connectionString, data, lines, distance, czmlfile, callback) {
   ...
   pg.connect(connectionString, function(err, client) {
      ...
      query.on('row', function(row, result) {
         ...
         var icon = "/images/star_yellow.png";
         var scale = 0.30;
...
exports.pgCreatePoint = function(connectionString, select, type, scale, czmlfile, callback) {
   ...
   var icon  = "/images/" + type.toLowerCase() + ".png";
   ...
   pg.connect(connectionString, function(err, client, done) {
      ...
      query.on('row', function(row) {
         ...
         czmlfile = czml.createPoint(id, row.site, description, icon, scale, row.x_coord, row.y_coord, row.z_coord, czmlfile);
         id++;
      });
      query.on('end', function () {
         callback(czmlfile);
