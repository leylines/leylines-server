...
exports.createPoints = function(data, icon, results) {
   ...
   for (var i=0, tot=data.length; i<tot; i++) {
      if (icon) {
         var icon = "/images/icons/button_yellow.png";
         var scale = 0.1;
      } else  {
         var icon = "";
         var scale = 1;
...
exports.createCorridor = function(connectionString, data, lines, distance, color, czmlfile) {
   ...
   return function (callback) {
      ...
      callback (null, connectionString, data, lines, distance, color, czmlfile);
   }
};
