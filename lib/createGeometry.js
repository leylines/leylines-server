...
exports.createPoints = function(points, showicon, czmlfile, type) {
   ...
   return function (callback) {
      ...
      callback (null, czmlfile, type);
      return;
   }

};

exports.createCorridor = function(connectionString, points, lines, distance, color, czmlfile) {
   ...
   return function (callback) {
      ...
      callback (null, connectionString, points, lines, distance, color, czmlfile);
      return;
   }
};

exports.createArea = function(czmlfile, polygons, callback) {
