...
exports.createPoints = function(res, points, showicon, czmlfile, type) {
   ...
   return function (callback) {
      ...
      callback (null, res, czmlfile, type);
      return;
   }

};

exports.createCorridor = function(res, connectionString, points, lines, distance, color, czmlfile) {
   ...
   return function (callback) {
      ...
      callback (null, res, connectionString, points, lines, distance, color, czmlfile);
      return;
   }
};
